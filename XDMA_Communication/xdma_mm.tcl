...
#
# xdma_mm.tcl: Tcl script for re-creating project 'xdma_mm'
#
# Generated by Vivado on Sun Nov 26 07:13:57 UTC 2023
...
#
# 1. This project restoration tcl script (xdma_mm.tcl) that was generated.
#
...
set_property -name "top" -value "xdma_mm_wrapper" -objects $obj
...
# Proc to create BD xdma_mm
proc cr_bd_xdma_mm { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name xdma_mm
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins xdma_0/axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x40010000 -range 0x00002000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.690672",
   "Default View_TopLeft":"-494,-207",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port pcie_7x_mgt_rtl_0 -pg 1 -lvl 4 -x 1320 -y 400 -defaultsOSRD
preplace port diff_clock_rtl_0 -pg 1 -lvl 0 -x 0 -y 180 -defaultsOSRD
preplace port port-id_reset_rtl_0 -pg 1 -lvl 0 -x 0 -y 450 -defaultsOSRD
preplace inst xdma_0 -pg 1 -lvl 1 -x 500 -y 440 -defaultsOSRD
preplace inst util_ds_buf -pg 1 -lvl 1 -x 500 -y 180 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 2 -x 860 -y 160 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 1160 -y 180 -defaultsOSRD
preplace inst smartconnect_1 -pg 1 -lvl 2 -x 860 -y 300 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 3 -x 1160 -y 480 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 3 -x 1160 -y 60 -defaultsOSRD -orient R180
preplace inst axi_bram_ctrl_1_bram -pg 1 -lvl 3 -x 1160 -y 600 -defaultsOSRD -orient R180
preplace netloc reset_rtl_0_1 1 0 1 NJ 450
preplace netloc util_ds_buf_IBUF_OUT 1 0 2 330 260 680
preplace netloc util_ds_buf_IBUF_DS_ODIV2 1 0 2 320 250 670
preplace netloc xdma_0_axi_aclk 1 1 2 690 70 1020
preplace netloc xdma_0_axi_aresetn 1 1 2 710 80 1000
preplace netloc xdma_0_pcie_mgt 1 1 3 NJ 400 NJ 400 NJ
preplace netloc diff_clock_rtl_0_1 1 0 1 NJ 180
preplace netloc xdma_0_M_AXI 1 1 1 700 140n
preplace netloc smartconnect_0_M00_AXI 1 2 1 N 160
preplace netloc xdma_0_M_AXI_LITE 1 1 1 720 280n
preplace netloc smartconnect_1_M00_AXI 1 2 1 1010 300n
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 1300 60n
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 3 1 1300 480n
levelinfo -pg 1 0 500 860 1160 1320
pagesize -pg 1 -db -bbox -sgen -160 0 1500 660
"
}
...
# End of cr_bd_xdma_mm()
cr_bd_xdma_mm ""
set_property REGISTERED_WITH_MANAGER "1" [get_files xdma_mm.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files xdma_mm.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse xdma_mm.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/xdma_mm.gen/sources_1/bd/xdma_mm/hdl/xdma_mm_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse xdma_mm.bd] -top]
